...
const HeroSection = () => {
    return (
        <section className='flex flex-col items-center min-h-screen max-w-4xl mx-auto gap-9 p-9 pb-1 md:flex-row md:justify-center xl:max-w-7xl'>
            <motion.div
            ...
            >
                ...
                <motion.h1 variants={transitionVariant} className='font-black text-[40px] leading-10 xl:text-7xl'>
                    Bring Your Drawings to Life with AI
                </motion.h1>
                <motion.p variants={transitionVariant} className='text-xs text-neutral-500 font-semibold xl:text-lg'>
